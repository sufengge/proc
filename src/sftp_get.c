...
int sftp_get()
{
	...
	//配置文件路径
    strcpy(CupSftpParmPath,"/home/sufg/proc/etc/");						//cupspl-sftp-parm.txt的路径
	strcpy(P5DataPatch,"/home/sufg/proc/data/p5dir/");					    //P5存放文件路径
	sprintf(P8DataPatch,"/home/sufg/proc/data/p8bak/%s/",systime);		    //P8文件备份路径
